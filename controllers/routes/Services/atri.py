...
class Atri:
	...
	@property
	def TextServices(self):
		self._getter_access_tracker["TextServices"] = {}
		return self._TextServices
	@TextServices.setter
	def TextServices(self, new_state):
		self._setter_access_tracker["TextServices"] = {}
		global default_state
		self._TextServices = TextBox(new_state, default_state["TextServices"])
	...
	@property
	def TextBo(self):
		self._getter_access_tracker["TextBo"] = {}
		return self._TextBo
	@TextBo.setter
	def TextBo(self, new_state):
		self._setter_access_tracker["TextBo"] = {}
		global default_state
		self._TextBo = TextBox(new_state, default_state["TextBo"])
	...
	def _to_json_fields(self):
		return {
			...
			"Div20": self._Div20,
			"Flex15": self._Flex15,
			"TextServices": self._TextServices,
			"Text": self._Text,
